...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void btnKargoAra_Click(object sender, EventArgs e)
        {
            ...
            dataKargo.Columns[1].HeaderText = "Gönderen Ad";
            dataKargo.Columns[2].HeaderText = "Gönderen Soyad";
            dataKargo.Columns[3].HeaderText = "En";
            dataKargo.Columns[4].HeaderText = "Boy";
            dataKargo.Columns[5].HeaderText = "Kg";
            dataKargo.Columns[6].HeaderText = "Mesafe";
            dataKargo.Columns[7].HeaderText = "Tür";
            dataKargo.Columns[8].HeaderText = "Fatura Tipi";
            dataKargo.Columns[9].HeaderText = "Ödeme Şekli";
            dataKargo.Columns[10].HeaderText = "Kargo Nerede";
            dataKargo.Columns[11].HeaderText = "Kargo Çıkış Tarihi";
            dataKargo.Columns[12].HeaderText = "Kargo Teslim Tarihi";
        ...
        private void btnTumu_Click(object sender, EventArgs e)
        {
            ...
            dataTumu.Columns[1].HeaderText = "Gönderen Ad";
            dataTumu.Columns[2].HeaderText = "Gönceren Soyad";
            dataTumu.Columns[3].HeaderText = "En";
            dataTumu.Columns[4].HeaderText = "Boy";
            dataTumu.Columns[5].HeaderText = "Kg";
            dataTumu.Columns[6].HeaderText = "Mesafe";
            dataTumu.Columns[7].HeaderText = "Tür";
            dataTumu.Columns[8].HeaderText = "Fatura Tipi";
            dataTumu.Columns[9].HeaderText = "Ödeme Şekli";
            dataTumu.Columns[10].HeaderText = "Kargo Nerede";
            dataTumu.Columns[11].HeaderText = "Kargo Çıkış Tarihi";
            dataTumu.Columns[12].HeaderText = "Kargo Teslim Tarihi";
        }
        private void btnGuncelListe_Click(object sender, EventArgs e)
        {
            ...
            dataGuncel.Columns[1].HeaderText = "Göndern Ad";
            dataGuncel.Columns[2].HeaderText = "Göndern Soyad";
            dataGuncel.Columns[3].HeaderText = "En";
            dataGuncel.Columns[4].HeaderText = "Boy";
            dataGuncel.Columns[5].HeaderText = "Kg";
            dataGuncel.Columns[6].HeaderText = "Mesafe";
            dataGuncel.Columns[7].HeaderText = "Tür";
            dataGuncel.Columns[8].HeaderText = "Fatura Tipi";
            dataGuncel.Columns[9].HeaderText = "Ödeme Şekli";
            dataGuncel.Columns[10].HeaderText = "Kargo Nerede";
            dataGuncel.Columns[11].HeaderText = "Kargo Çıkış Tarihi";
            dataGuncel.Columns[12].HeaderText = "Kargo Teslim Tarihi";
        }
        private void dataGuncel_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            txtSorEn.Text = dataGuncel.CurrentRow.Cells[3].Value.ToString();
            txtSorBoy.Text = dataGuncel.CurrentRow.Cells[4].Value.ToString();
            txtSorKg.Text = dataGuncel.CurrentRow.Cells[5].Value.ToString();
            cmbSorMesafe.SelectedItem = dataGuncel.CurrentRow.Cells[6].Value.ToString();
            cmbSorTur.SelectedItem = dataGuncel.CurrentRow.Cells[7].Value.ToString();
            if (dataGuncel.CurrentRow.Cells[8].Value.Equals("Bireysel"))
            {
                rbSorBireysel.Checked = true;
            }
            else
                rbSorTicari.Checked = true;
            if (dataGuncel.CurrentRow.Cells[9].Value.Equals("Gönderici Ödemeli"))
            {
                rbSorGonder.Checked = true;
            }
            else
                rbSorAlici.Checked = true;
            cmbSorDurum.SelectedItem = dataGuncel.CurrentRow.Cells[10].Value.ToString();
            dateSorOlusum.Text = dataGuncel.CurrentRow.Cells[11].Value.ToString();
            dateSorTeslim.Text = dataGuncel.CurrentRow.Cells[12].Value.ToString();
